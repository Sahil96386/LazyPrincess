...
ADMIN_USRNM = environ.get('ADMIN_USRNM','Sahilrjs') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','harshgrp') # WITHOUT @
...
LZURL_PRIME_USERS = [int(lazyurlers) if id_pattern.search(lazyurlers) else lazyurlers for lazyurlers in environ.get('LZURL_PRIME_USERS', '6952368011').split()]
